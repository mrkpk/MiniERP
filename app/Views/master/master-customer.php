                        ...
                        <div class="container-fluid">
                            <div class="col-md-12">
                                ...
                                <div class="card card-secondary">
                                    ...
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                        <form role="form" id="formcust" action="/kirimmastercustomer" method="post" enctype="multipart/form-data" onsubmit="validateForm(event)">
                                            <div class="row">
                                                <div class="col-sm-3">
                                                    <!-- text input -->
                                            ...
                                            <div id="row">
                                                <div class="col-sm-3 offset-5">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <input type="submit" class="btn btn-primary" value="Kirim Master Customer" />
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body table-responsive p-0">
                                                <table class="table table-hover text-nowrap table-bordered elevation-4">
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($cust as $sto) { ?>
                                                            <tr>
                                                                <td><?= $sto['kode_customer'] ?></td>
                                                                <td><?= $sto['nama_customer'] ?></td>
                                                                <td><?= $sto['lokasi_customer'] ?></td>
                                                            </tr>
                                                        <?php } ?>
                                                    </tbody>
                                                </table>
