                                            ...
                                            <div class="row" id="row1">
                                                ...
                                                <div class="col-sm-1">
                                                    <div class="form-group"> <label>Ball</label>
                                                        <div class="input-group"> <input type="text" class="form-control qty" value="<?= $temp[$i]['ball_pembelian']; ?>" readonly="true" />
                                                        </div>
                                                ...
                                                <div class="col-sm-1"><!-- text input -->
                                                    <label>Qty</label>
                                                    <div class="input-group"> <input type="text" class="form-control qty" value="<?= $temp[$i]['qty_perbal']; ?>" readonly="true" /> </div>
                                                </div>
                            ...
                            <div id="frm">
                                ...
                                ?>
                                    ...
                                    <div class="row" id="row1">
                                        ...
                                        <div class="col-sm-1">
                                            <div class="form-group"> <label>Ball</label>
                                                <div class="input-group"> <input type="text" class="form-control ball" name="satuan[<?= $l; ?>]" id="satuan-<?= $l; ?>" value="<?= $base[$i]['ball_pembelian']; ?>" /> </div>
