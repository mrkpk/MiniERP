                                                        ...
                                                        <div class="row" id="row1">
                                                            ...
                                                            <div class="col-sm-1">
                                                                <div class="form-group"> <label>Ball</label>
                                                                    <div class="input-group"> <input type="text" class="form-control qty" name="satuan[1]" id="satuan-1" /> </div>
