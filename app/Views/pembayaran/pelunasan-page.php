    ...
    $(document).on('change', '#cust', function() {
        ...
        if (id != 0) {
            ambilTransCust(id).then(cust => {
                ...
                var pesan = "";
                var l = 1;
                var komulatiftotal = 0;
                var komulatifbayar = 0;
                var sisa = 0;
                ...
                for (var i = 0; i < cust.length; i++) {
                    ...
                    baris += '<tr>' +
                        ...
                        '<tr>';
                    komulatiftotal = Number(komulatiftotal) + Number(cust[i].total_penjualan_diskon);
                    komulatifbayar = Number(komulatifbayar) + Number(cust[i].jumlah_pelunasan);
                }
                sisa = komulatiftotal - komulatifbayar;
                total = '<tr>' +
                    '<th colspan=3></th>' +
                    '<th style="color: #B22222 ;">Rp.' + komulatiftotal + ',-</th>' +
                    '<th style="color: #50C878 ;">Rp.' + komulatifbayar + ',-</th>' +
                    '</tr>' +
                    '<tr>' +
                    '<th colspan=3>Sisa Tagihan</th>' +
                    '<th colspan =2 style="color: #B22222 ;text-align:center">Rp.' + sisa + ',-</th>' +
                    '</tr>';
                $('#head1').html(barhead);
                $('#data1').html(baris);
                $('#total1').html(total);
