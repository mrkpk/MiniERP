                                                        ...
                                                        <div class="form-group"> <label>Metode Pembayaran</label>
                                                            <div class="input-group">
                                                                <select class="form-control" id="exampleFormControlSelect1" name="metode">
                                                                    ...
                                                                    <option value="11104">BRI</option>
                                                                    <option value="11102">BCA</option>
                                                                    <option value="11111">Tunai</option>
                                                                </select>
...
<script>
    ...
    function validateForm(e) {
        ...
        var coa = document.getElementById("exampleFormControlSelect1").value;
        console.log(coa);
        ...
        if (notrans == "" || bayar == "") {
            ...
            alertify
                .alert("Ooopss..", "Harap pilih metode pembayaran.");
            return false;
        } else {
