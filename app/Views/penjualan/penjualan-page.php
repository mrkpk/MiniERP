                                ...
                                <div class="row" id="row1">
                                    ...
                                    <div class="col-sm-1"><!-- text input -->
                                        <div class="form-group"><label>Ball</label>
                                            <div class="input-group">
                                                <input type="text" class="form-control qty" name='satuan[1]' id="satuan-1" />
                                            </div>
                                        </div>
...
<script>
    ...
    function validateForm(e) {
        ...
        for (k = 1; k <= i; k++) {
            ...
            if (nama = "" || gudang == "" || ball == "" || qty == "" || harga == "" || jumlah == "" || sales == "") {
                alertify
