                            ...
                            <div id="frm">
                                ...
                                ?>
                                    ...
                                    <div class="row" id="row1">
                                        ...
                                        <div class="col-sm-3"><!-- text input -->
                                            <div class="form-group">
                                                <label id="trw-<?= $l; ?>">Kode (Sisa stock = <?= $base[$i]['qty_stock_kum']; ?>)</label><select class="form-control select2 select" style="width: 100%;" name='nama[<?= $l; ?>]' id="nama-<?= $l; ?>">
                                        ...
                                        <div class="col-sm-1">
                                            <div class="form-group"><label>Ball</label>
                                                <div class="input-group">
                                                    <input type="text" class="form-control qty" name='satuan[<?= $l; ?>]' id="satuan-<?= $l; ?>" value="<?= $base[$i]['ball_penjualan']; ?>" />
                                                    <input type="hidden" class="form-control" id="slap-<?= $l; ?>" value="1" />
                                                </div>
                                            </div>
                                            <div class="form-group"> <label id="label-<?= $l ?>" style="font-size: 12px;">Qty(<?= $base[$i]['satuan']; ?>)</label>
                                                <div class="input-group">
                                                    <input type="text" class="form-control qty" name='qty[<?= $l; ?>]' id="qty-<?= $l; ?>" value="<?= $base[$i]['qty_perbal']; ?>" />
...
<script>
    ...
    function validateForm(e) {
        ...
        for (k = 1; k <= i; k++) {
            ...
            var ball = Number(document.getElementById("satuan-" + k).value);
            var qty = Number(document.getElementById("qty-" + k).value);
            var slap = Number(document.getElementById("slap-" + k).value);
            ...
            if (nama = "" || gudang == "" || ball == "" || harga == "" || jumlah == "") {
                ...
                return false;
            } else if ((ball * qty) > (qtybase + qtyawal)) {
