...
$routes->post('/sj-print', 'PenjualanController::penjualanPrintsj');
...
$routes->get('/master-customer', 'MasterController::masterCustomer');
$routes->post('/kirimmastercustomer', 'MasterController::kirimMasterCustomer');
$routes->get('/master-supplier', 'MasterController::masterSupplier');
$routes->post('/kirimmastersupplier', 'MasterController::kirimMasterSupplier');
